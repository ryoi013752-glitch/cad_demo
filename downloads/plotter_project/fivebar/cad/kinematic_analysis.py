...
# Link lengths
L1 = L4 = 67.27   # Length of driven links from A to B and E to D
L2 = L3 = 110     # Length of middle links from B to C and D to C

# Fixed base coordinates
A = np.array([0.0, 0.0])         # Base point A
E = np.array([-50.0, 0.0])       # Base point E
...
if __name__ == "__main__":
    ...
    theta1 = np.radians(45)  # 45° clockwise
    theta2 = np.radians(240)  # 60° counterclockwise
